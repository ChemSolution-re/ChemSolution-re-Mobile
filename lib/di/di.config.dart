...
import '../bloc/auth/login_page/login_page_cubit.dart' as _i13;
import '../bloc/blog_post_page/blog_post_page_cubit.dart' as _i15;
...
import '../bloc/main_page/news_and_facts_tab/news_and_facts_tab_cubit.dart'
    as _i14;
import '../models/blog_post/blog_post.dart' as _i16;
...
Future<_i1.GetIt> $configureDependencies(_i1.GetIt get,
  ...
  gh.factory<_i13.LoginPageCubit>(() => _i13.LoginPageCubit(
      get<_i10.AuthService>(), get<_i3.PreferencesService>()));
  gh.factory<_i14.NewsAndFactsTabCubit>(
      () => _i14.NewsAndFactsTabCubit(get<_i11.BlogPostsService>()));
  gh.factoryParam<_i15.BlogPostPageCubit, _i16.BlogPost?, dynamic>(
      (blogPost, _) =>
          _i15.BlogPostPageCubit(get<_i11.BlogPostsService>(), blogPost));
  return get;
}
